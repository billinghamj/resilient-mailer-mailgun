...
test('api port is chosen correctly', function (t) {
	var prov1 = new MailgunProvider('domain', 'key');
	var prov2 = new MailgunProvider('domain', 'key', { apiSecure: false });
	var prov3 = new MailgunProvider('domain', 'key', { apiSecure: true });
